        ...
        {servicesData.map((item, index) => (
          <SwiperSlide key={index}>
            <div className="relative w-full h-full">
              ...
              {/* Animated Centered Content (key = activeIndex to retrigger animation) */}
              <motion.div
                key={activeIndex}
                className="absolute inset-0 flex flex-col items-center justify-center px-6 sm:px-8 md:px-12 z-10 text-center pt-16 sm:pt-20 md:pt-24"
              ...
              >
                ...
                <motion.div
                  className="bg-white/70 w-full max-w-[804px] lg:max-w-[900px] xl:max-w-[1000px] p-4 sm:p-6 md:p-8 rounded-md shadow-lg"
